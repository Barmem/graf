...
{"class":"title",text:"\u0412\u0430\u0448\u0435 \u0433\u0440\u0430\u0444\u0444\u0438\u0442\u0438 \u043d\u0430  \u0441\u0442\u0435\u043d\u0443 Свят"})),$("<div/>",{"class":"topbar"}).append($("<div/>",{"class":"fl_l"}).append(this.cleanBtn,"<span> | </span>",this.cancelBtn),$("<div/>",{"class":"fl_r"}).append(this.saveBtn,"<span> | </span>",this.fullBtn)),$("<div/>",{"class":"canvas_wrap"}).append($("<div/>",{"class":"canvas_aligner",width:a.width,height:a.height}).append(this.$canvas.addClass("main"),
