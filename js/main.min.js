...
{"class":"title",text:"Специально для Свята"})),$("<div/>",{"class":"topbar"}).append($("<div/>",{"class":"fl_l"}).append(this.cleanBtn,"<span> | </span>",this.cancelBtn),$("<div/>",{"class":"fl_r"}).append(this.saveBtn,"<span> | </span>",this.fullBtn)),$("<div/>",{"class":"canvas_wrap"}).append($("<div/>",{"class":"canvas_aligner",width:a.width,height:a.height}).append(this.$canvas.addClass("main"),
